...
<body>
    <div id="container">
        ...
        <div id="middle">
            <div class="linkarea">
                <div class="tablinks">位置：<a href="Showlist.aspx?typeid=<%=Request.QueryString["typeid"] %>"><%=titlename %></a></div>
            </div>
            <div class="leftimg">
            ...
            <div class="rightcontent">
                <%=Adapte.sys.getArticlePager(Request.QueryString["page"], 22, 80, Request.QueryString["typeid"], true,6) %>
            </div>
            <div class="leftlink">

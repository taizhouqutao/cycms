<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacherEdit2.aspx.cs" Inherits="cycms.Web.admin.teacherManager.teacherEdit2" %>
...
<body>
	...
	<fieldset>
        ...
        <div style="margin-left:20px; ">
		    ...
		    <legend>公开信息</legend>
		        <div>
                    <ul>                    
                        <li>登&nbsp;&nbsp;陆&nbsp;&nbsp;名：<asp:TextBox ID="txtLoginName" runat="server"></asp:TextBox></li>
       ...
       <fieldset style="text-align:left;width:680px;">
		    <legend>信息管理</legend>
                <div style="margin-left:20px;">
                    <ul>
                        <li>密码：<asp:TextBox runat="server" ID="txtPassword"></asp:TextBox></li>
                   </ul>
                </div>
                <div style="margin-left:20px;">
                    <ul>
                        <li>排序：<asp:TextBox runat="server" ID="txtOrder" Text="1"></asp:TextBox></li>
                   </ul>
                </div>
                
                <div style="margin-left:20px;">
                    <ul>
                        <li>是否显示：<asp:CheckBox runat="server" ID="isDisplay" Checked="true" /></li>
                   </ul>
                </div>
	    </fieldset>
        <fieldset style="text-align:left;width:680px;">
	...
	<div style="text-align:center;">
	    <asp:Button ID="saveBtn" runat="server" CssClass="buttom" Text="添加" OnClick="saveBtn_Click" />
	    <input type="button" id="btnCancel" value="返回" class="buttom" style="width:60px;" onclick="javascript:window.location.href='teacher_list.aspx'"  />
	</div>
	
	<asp:Panel runat="server" ID="pnlResumes" Visible="false">
        <fieldset>
		    <legend>工作简历</legend>
		    <div>
		        <a name="#resumes1"></a>
		        ...
		        <asp:Panel runat="server" ID="pnl1" Width="100%" CssClass="nodisplay" style="display:none">
		             开始时间：<asp:TextBox runat="server" ID="txtStartTime1" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
		             结束时间：<asp:TextBox runat="server" ID="txtendTime1" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
	    ...
	    <fieldset>
		    ...
		    <div>
		        ...
		        <asp:Panel runat="server" ID="pnl2" Width="100%" CssClass="nodisplay" style="display:none">
		             开始时间：<asp:TextBox runat="server" ID="txtStartTime2" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
		             结束时间：<asp:TextBox runat="server" ID="txtendTime2" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
                    ...
                    <br />
		             毕业时间：<asp:TextBox runat="server" ID="txtGraduateTime" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
                    <br />
		    ...
		    <div>
		        ...
		        <asp:GridView runat="server" ID="GridView3" AutoGenerateColumns="False" Width="100%" CssClass="grid" DataKeyNames="id" OnRowCommand="GridView3_RowCommand" OnRowDeleting="GridView3_RowDeleting">
                    <Columns>
                        <asp:BoundField DataField="dbo_startTime" DataFormatString="{0}" HeaderText="开始时间" />
                        <asp:BoundField DataField="dbo_endTime" DataFormatString="{0}" HeaderText="结束时间" />
                        <asp:BoundField DataField="dbo_theClass" DataFormatString="{0}" HeaderText="部门" />
		        ...
		        <asp:Panel runat="server" ID="pnl3" Width="100%" CssClass="nodisplay" style="display:none">
		             开始时间：<asp:TextBox runat="server" ID="txtStartTime3" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
		             结束时间：<asp:TextBox runat="server" ID="txtendTime3" Width="103px" class="Wdate" onfocus="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
